...
impl windowseventsprobe {
    ...
    pub fn windows_events_security_logs(&mut self) {
        ...
        self.security_logs = format!("probing security logs... \n").cyan().bold().to_string();
        ...
        for record in parser.records() {
            match record {
                Ok(r) => {
                    self.security_logs.push_str(format!(" {}", r.event_record_id).as_str());
                    let mut totalspaces = 0;
                    ...
                    if startindex == 15 {
                        ...
                        self.security_logs.push_str(format!("{}", final_string).as_str());
                        totalspaces = 46 - final_string.len();
                    }
                    ...
                    //logic to print spaces - 30 spaces
                    if startindex == 12 {
                        self.security_logs.push_str(format!("No time found.").as_str());
                        totalspaces = 30 - ("No time found.".len());
                    } else {
                        self.security_logs.push_str(format!("{}", final_string).as_str());
                        totalspaces = 30 - (final_string.len());
                    ...
                    if startindex == 15 {
                        ...
                        self.security_logs.push_str(format!("{}", finall_string).as_str());
                        totalspaces = 20 - (finall_string.len());
                    }
...
impl windowseventsprobe {
    ...
    pub fn windows_events_setup_logs(&mut self) {
        ...
        self.setup_logs = format!("probing setup logs... \n").cyan().bold().to_string();
        ...
        for record in parser.records() {
            match record {
                Ok(r) => {
                    self.setup_logs.push_str(format!(" {}", r.event_record_id).as_str());
                    let mut totalspaces = 0;
                    ...
                    if startindex == 15 {
                        ...
                        self.setup_logs.push_str(format!("{}", final_string).as_str());
                        totalspaces = 46 - final_string.len();
                    }
                    ...
                    //logic to print spaces - 30 spaces
                    if startindex == 12 {
                        self.setup_logs.push_str(format!("No time found.").as_str());
                        totalspaces = 30 - ("No time found.".len());
                    } else {
                        self.setup_logs.push_str(format!("{}", final_string).as_str());
                        totalspaces = 30 - (final_string.len());
                    ...
                    if startindex == 15 {
                        ...
                        self.setup_logs.push_str(format!("{}", finall_string).as_str());
                        totalspaces = 20 - (finall_string.len());
                    }
...
impl windowseventsprobe {
    ...
    pub fn windows_events_system_logs(&mut self) {
        ...
        self.system_logs = format!("probing system logs... \n").cyan().bold().to_string();
        ...
        for record in parser.records() {
            match record {
                Ok(r) => {
                    self.system_logs.push_str(format!(" {}", r.event_record_id).as_str());
                    let mut totalspaces = 0;
                    ...
                    if startindex == 15 {
                        ...
                        self.system_logs.push_str(format!("{}", final_string).as_str());
                        totalspaces = 46 - final_string.len();
                    }
                    ...
                    //logic to print spaces - 30 spaces
                    if startindex == 12 {
                        self.system_logs.push_str(format!("No time found.").as_str());
                        totalspaces = 30 - ("No time found.".len());
                    } else {
                        self.system_logs.push_str(format!("{}", final_string).as_str());
                        totalspaces = 30 - (final_string.len());
                    ...
                    if startindex == 15 {
                        ...
                        self.system_logs.push_str(format!("{}", finall_string).as_str());
                        totalspaces = 20 - (finall_string.len());
                    }
